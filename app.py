...
TAG_MAP = {
"ShortDistance":("tag-short","短距離"),"LongDistance":("tag-long","長距離"),
"Burst":("tag-burst","バースト"),"Grind":("tag-grind","グラインド"),
"Balanced":("tag-long","バランス"),"Endurance":("tag-grind","持久"),
}
...
return f’<div class="hp-bar-wrap"><div class="hp-bar" style="width:{pct}%;"></div></div><small style="color:var(--dim);">HP: {current} / {max_hp}</small>’
